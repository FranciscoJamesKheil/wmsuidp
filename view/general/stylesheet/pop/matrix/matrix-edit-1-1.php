<?php
    ...
    if($mysqli === false) {
	  ...
	  $id = $_GET['GetID'];
    $sql = "SELECT * FROM wodesignation WHERE instruction= '". $id . "' AND rank_type='Proffesors';";
    ...
    <main>
      ...
      <section>
        ...
        <div class="modal-content">
          <form action="./update-matrix-1-1.php" method="POST">
            <h2><span class="fas fa-cogs"></span> Update Attributes</h2>
            <div class="content">
              <div class="text-content">
                <label for="">Rank:</label>
                <input type="text" value="Proffesors" disabled/>
              </div>
